...
class ParFormer(nn.Module):
    def __init__(self, img_size=224, num_classes=1000, embed_dims=[64, 128, 384, 512], depths=[3, 3, 9, 3],
                 ...
                 patch_attention=True, pretrained=None, **kwargs):
        super().__init__()
        self.depths = depths
...
class ParFormer_B1(ParFormer):
    def __init__(self, **kwargs):
        super(ParFormer_B1, self).__init__(
...
@BACKBONES.register_module()
class ParFormer_B2(ParFormer):
    def __init__(self, **kwargs):
        super(ParFormer_B2, self).__init__(
...
@BACKBONES.register_module()
class ParFormer_B3(ParFormer):
    def __init__(self, **kwargs):
        super(ParFormer_B3, self).__init__(
